...
- `backend.md` — Tauri/native (src-tauri) modules and Rust bridge
- `lib.md` — Core library utilities and generation flow
- `state.md` — Zustand/store and persistence explanation
- `testing.md` — Tests, linting, and running CI locally
- `build.md` — Build, run, and release instructions
- `contributing.md` — Coding guidelines and contribution process
- `api-schemas.md` — JSON schemas and data formats
