                  ...
                  <div className="mx-auto w-full max-w-8xl px-4 sm:px-6 lg:px-8 xl:px-12 py-4 sm:py-6 lg:py-8">
                    {activeFeedback ? (
                      ...
                      <QuestionSplitLayout
                        ...
                        leftSlot={<MarkdownMath content={activeQuestion.promptMarkdown} />}
                        rightSlot={
                          <WrittenAnswerCard
                            questionId={activeQuestion.id}
                            answer={activeQuestionAnswer}
                        ...
                        leftSlot={
                          <div className="space-y-5">
                            <div className="p-6 bg-muted/20 rounded-md space-y-2">
                              <h1 className="text-xl font-bold">Question {activeMcQuestionIndex + 1}</h1>
                            ...
                            {mcSketchpadActive && (
                              <div className="min-w-0">
                                <McAnswerCard
                                  ...
                                  onToggleSketchpad={() => setMcSketchpadActive((prev) => !prev)}
