          ...
          <div className="mt-2 space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p
                  className={`font-bold text-base mb-2 ${isCorrect ? 'text-emerald-900 dark:text-emerald-100' : 'text-rose-900 dark:text-rose-100'}`}
                >
                  {isCorrect
                    ? 'Correct!'
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <Input
                          ...
                          value={overrideInput}
                          onChange={(e) =>
                            onOverrideInputChange(e.target.value)
                          }
                        />
