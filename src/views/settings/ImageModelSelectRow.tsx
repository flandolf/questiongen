...
import { getCachedImageValidation, setCachedImageValidation } from "./imageValidationCache";

export function ImageModelSelectRow({ id, value, disabled, apiKey, onSelect, onSearch, placeholder = "Select a vision model" }: {
  id: string;
  value: string;
  disabled?: boolean;
  apiKey: string;
