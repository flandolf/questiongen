...
export function QuestionTimerBar({
  ...
  const showExpired = isQuestionExpired && mode === "exam";

  return (
    <div className="relative w-full flex items-center justify-between gap-2 px-2 py-1 bg-muted/60 rounded-lg border border-border/40 mb-2">
      {showExpired ? (
