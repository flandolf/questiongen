...
export function Layout() {
  return (
    <div className="flex bg-background text-foreground overflow-hidden h-dvh in-[.platform-android]:h-(--android-app-height,100dvh) in-[.platform-android]:min-h-(--android-app-height,100dvh) in-[.platform-android]:pt-[max(0.5rem,env(safe-area-inset-top,0px))]">
      <Sidebar />
