...
`,
  ...
  "Applied Biomechanics: Newton’s Laws, Projectile Motion, and Levers": `Use clear, concise prompts focused on applying Newton's Laws to real-world scenarios, analyzing projectile motion, and evaluating lever systems in biomechanics. Require students to provide explanations of forces, and practical applications in sports or human movement contexts. Avoid focusing on caluclations, instead prioritise conceptual understanding and application of principles to novel situations.`,
};
