...
`,
  ...
  "Trigonometric Functions": `
Functions: sin(x), cos(x), tan(x) and transformations.
Standard form: y = a·sin(b(x − h)) + k or y = a·cos(b(x − h)) + k
  – Amplitude = |a|; Period = 2π/b for sin/cos, π/b for tan; Range = [k − |a|, k + |a|]
Exact values: sin, cos, tan of 0, π/6, π/4, π/3, π/2, π, 3π/2, 2π and related angles.
Solving trigonometric equations: identify reference angle, use periodicity to list all solutions in the domain.
Asymptotes for tan: occur where cos(bx + c) = 0, i.e., b(x − h) = π/2 + nπ for integer n.
Newton's method: x_{n+1} = x_n − f(x_n)/f'(x_n); apply iteratively from given x_0.
`,
...
`,
  "Unit 1 AoS 1: Nature and Functions of Language": `Focus on language as a rule-governed meaning-making system and the functions of human communication. Emphasize the major functions of language: referential, emotive, conative, phatic, metalinguistic, and poetic. Require precise metalanguage regarding situational context (field, setting, mode) and tenor (participant relationships). Include stimulus excerpts requiring analysis of morphology (morpheme types, affixation), lexicology (word classes, function vs. content words), and syntax (phrases, clauses, sentence structures). Students must explain how linguistic choices reflect register and authorial intent.`,
  "Unit 1 AOS 2: Language Acquisition": `Focus on first-language development, additional-language acquisition, and acquisition theories (e.g., usage-based and universalist accounts). Require students to apply evidence from child/adolescent language data and evaluate explanations. Include critical period debates, caretaker talk, overgeneralization, and developmental milestones using explicit linguistic evidence.`,
  "Unit 2 AOS 1: English Across Time": `Frame questions around historical development of English and subsystem change across periods. Include etymology, standardization, orthographic change, semantic shift, and phonological change (e.g., Great Vowel Shift). Demand clear cause-and-effect analysis using social, technological, and contact-driven drivers of change.`,
  "Unit 2 AOS 2: Englishes in Contact": `Emphasize contact varieties, global Englishes, and sociocultural consequences of language contact. Include pidgins, creoles, Aboriginal Englishes, and world Englishes with context-sensitive analysis. Require discussion of language maintenance, shift, prestige, attitudes, and identity impacts using accurate metalanguage and specific examples.`,
  "Unit 3 AOS 1: Informality": `Build prompts around contemporary Australian informal language, solidarity, and rapport-building. Require analysis of lexical choices, discourse particles, idioms, contractions, overlaps, and interactional strategies. Students should evaluate how features shape social goals, relationships, and audience alignment.`,
  "Unit 3 AOS 2: Formality": `Prioritize formal register in institutional or public settings where authority, expertise, or distance is managed. Require close analysis of syntax, modality, nominalization, hedging, politeness strategies, and discourse structure. Include comparisons of formal and informal choices and justify contextual effectiveness.`,
  "Unit 4 AOS 1: Language Variation in Australian Society": `Focus on variation across social and regional dialects in Australian contexts, including standard and non-standard forms. Require analysis of how phonological, lexical, and discourse features index social meaning and group membership. Include identity, power, and attitudes toward varieties in contemporary Australia.`,
  "Unit 4 AOS 2: Individual and Group Identities": `Emphasize idiolect, sociolect, ethnicity, gender, age, occupation, and community affiliations in identity construction. Require evaluation of how language choices perform alignment, inclusion, exclusion, authority, and authenticity. Analytical tasks should reward argument quality, evidence integration, and nuanced discussion of language attitudes and ideology.`,
  "Applied Biomechanics: Newton's Laws, Projectile Motion, and Levers": `Focus on applying Newton's Laws, projectile motion, and lever systems to authentic sports and human movement contexts. Require students to explain forces, analyze biomechanical actions, and evaluate real-world movement patterns. Prioritize conceptual understanding and application to novel situations over pure calculations; VCE biomechanics assesses analytical reasoning, not mathematical fluency.`,
};
